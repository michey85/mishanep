          ...
          <Chakra.DrawerBody>
            ...
            <Chakra.Accordion mt={4}>
              ...
              <Chakra.AccordionItem>
                ...
                <Chakra.AccordionPanel pb={4}>
                  Назначается встреча в Zoom. Вам на почту приходит ссылка на подключение,
                  в Google Календарь (если вы им пользуетесь) автоматически добавляется
                  слот на консультацию. Zoom - сервис видео звонков, позволяет делиться
                  экраном. Запись во время консультации не ведется.
                </Chakra.AccordionPanel>
              </Chakra.AccordionItem>
              ...
              <Chakra.AccordionItem>
                ...
                <Chakra.AccordionPanel pb={4}>
                  ...
                  Продолжительность - 30 минут или более.
                </Chakra.AccordionPanel>
              </Chakra.AccordionItem>
